...
//  }
  sh '''
curl -v -u NEXUS_USR:NEXUS_PSW --upload-file ${COMPONENT}.${gitTag}.zip http://3.237.181.62:8081/nexus/content/repositories/releases/org/{COMPONENT}/${COMPONENT}.${gitTag}.zip
'''
